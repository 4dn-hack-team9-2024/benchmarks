...
@click.option('--output-folder', 'folder', required=False, type=str, help='Output folder name, or None if skip writing output', default=None)
...
def test_hoomd(GPU, N, folder, n_steps, step_size, box_size, density):
    start = time.time()
